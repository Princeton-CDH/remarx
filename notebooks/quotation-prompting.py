...
def _():
    ...
    return get_text_response, highlight_bracketed_text, mo, pl, submit_prompt
...
@app.cell
def _(highlight_text_span, mo, page_text_i256, rows):
...
@app.cell
def _(highlight_text_span, mo, page_text_i661, rows):
...
@app.cell
def _(basic_prompt, page_text_i256, page_text_i661, submit_prompt):
    ...
    return basic_response, basic_responses, sample_page


@app.cell
def _(basic_responses):
    basic_responses
    return
...
@app.cell
def _(one_shot_prompt, page_text_i256, page_text_i661, submit_prompt):
    one_shot_responses = []
    ...
    return one_shot_response, one_shot_responses


@app.cell
def _(get_text_response, highlight_bracketed_text, one_shot_responses):
