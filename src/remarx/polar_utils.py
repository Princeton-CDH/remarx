...
def load_candidate_sentences(
    ...
    additional columns:
        ...
        * start_idx: starting character index of sentence (same as char_idx)
        * phrase list: list of sentences matching search phrases
    """
    # Load initial data
...
def join_candidates_annotation(
    ...
    title mention annotations to have been produced by `compile_title_annotations`
    script and candidate sentences to have been loaded by using
    ...
    unannotated_sents = candidate_sentences_df.filter(
        ...
        pl.lit(None).alias("anno_start_idx"),
        pl.lit(None).alias("anno_end_idx"),
